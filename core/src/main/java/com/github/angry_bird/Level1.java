...
public class Level1 implements Level {
    ...
    public void createlevel(LevelScreen levelScreen, World world) {
        ...
        // levelScreen.blockList.add(new StoneBlock(world, levelScreen, 12.0f, 1.5f));
        // // A new type of block for variety
        StoneBlock block1 = new StoneBlock(world, levelScreen, 12.0f, 3.0f);
        block1.transform(12.1f, 3.0f, 90); // Rotated block for structural complexity
        levelScreen.blockList.add(block1);

        StoneBlock block2 = new StoneBlock(world, levelScreen, 13.2f, 3.0f);
        block2.transform(14.3f, 3.0f, 90); // Rotated block for structural complexity
        levelScreen.blockList.add(block2);

        levelScreen.blockList.add(new GlassBlock(world, levelScreen, 13.2f, 3.0f));
        /*
